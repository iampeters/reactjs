...
import { getAggregators } from '../../../redux/actions/aggregatorActions';
import Animations from '../../../components/Skeleton/Text';
import Pagination from "react-js-pagination";

export default function Aggregators() {

  const aggregators = useSelector( state => state.aggregator );
  ...
  useEffect( () => {
    window.scrollTo( 0, 0 );
    dispatch( getAggregators( paginationConfig ) );
    ...
    return (
      <>
              ...
              <div className="form-row">
                ...
                <div className="col-md-12">
                  <div className="form-group">
                    ...
                    <button type='reset' className="btn btn-light text-danger" onClick={() => dispatch( getAggregators( paginationConfig ) )}>Reset</button>
                  </div>
                </div>
              </div>
            </form>
        ...
        <div className="border-radius bg-white p-3 box-shadow-mild animated fadeIn">
          <ListTable tableHead={headers} tableData={aggregators.items} seedIndex={getIndexSeed} />
          <div className='row m-0 justify-content-end'>
            <Pagination
              activePage={page}
              itemsCountPerPage={paginationConfig.pageSize}
              totalItemsCount={aggregators.total}
